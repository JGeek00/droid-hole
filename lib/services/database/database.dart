...
Future upgradeDbToV17(Database db) async {
  await db.execute("ALTER TABLE appConfig ADD COLUMN piholeV6InfoReaden NUMERIC");
  await db.execute("UPDATE appConfig SET piholeV6InfoReaden = 0");
}
...
Future<Map<String, dynamic>> loadDb() async {
  ...
  Database db = await openDatabase(
    ...
    onCreate: (Database db, int version) async {
      ...
      await db.execute("CREATE TABLE appConfig (autoRefreshTime NUMERIC, theme NUMERIC, overrideSslCheck NUMERIC, oneColumnLegend NUMERIC, reducedDataCharts NUMERIC, logsPerQuery NUMERIC, passCode TEXT, useBiometricAuth NUMERIC, importantInfoReaden NUMERIC, hideZeroValues NUMERIC, statisticsVisualizationMode NUMERIC, piholeV6InfoReaden NUMERIC)");
      await db.execute("INSERT INTO appConfig (autoRefreshTime, theme, overrideSslCheck, oneColumnLegend, reducedDataCharts, logsPerQuery, passCode, useBiometricAuth, importantInfoReaden, hideZeroValues, statisticsVisualizationMode, piholeV6InfoReaden) VALUES (5, 0, 0, 0, 0, 2, null, 0, 0, 0, 0, 0)");
    },
